...
export const getSlickNews = () => {
  const news = [
    ...
    },
    {
      key: 2,
      imageUrl:
        'https://www.gannett-cdn.com/media/2020/08/30/USATODAY/usatsports/247WallSt.com-247WS-731827-imageforentry5310.jpg?width=2560',
      title: 'Una noticia importante',
    ...
    },
    {
      key: 3,
      imageUrl:
        'https://www.momondo.com/discover/wp-content/uploads/sites/260/2017/11/56dc3858-4b63-3d46-a666-7533edc4bedf.jpg',
      title: 'Una noticia importante',
    ...
    },
    {
      key: 4,
      imageUrl:
        'https://educationpost.org/wp-content/uploads/2020/01/current-events-880x393-716x320.jpg',
      title: 'Una noticia importante',
